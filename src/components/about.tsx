...
const features = [
  {
    ...
    description: "Sourced from the finest farms across Ethiopia, Colombia, and Indonesia.",
  },
  {
    icon: Moon,
    title: "Night Ambiance",
    description: "Designed for those who find inspiration in the quiet hours after dark.",
  },
  {
    icon: Sparkles,
    title: "Artisan Craft",
    description: "Every cup is handcrafted with precision and passion by our expert baristas.",
  },
];
